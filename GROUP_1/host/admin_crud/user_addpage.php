...
<html>
<head>
	<title>PHP PROJECT - User-Dashboard</title>
...
<a href="../host_logout.php">Log Out</a>
		...
		<form action="user_add.php" method="post">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="insert2" value="   Save  "><br><br><br>
			</div>
		</form>
<br>
</div>
...
<?php
	...
	while($row=$pdoResult->fetch(PDO::FETCH_ASSOC)) {
		...
		echo "<td>$pword</td>";
		echo "<td>$fullname</td>";
		echo "<td><a class = 'table_button' href='user_edit.php?id=$id';>Edit</a> <a class = 'table_button' href='user_del.php?id=$id';?>Delete</a></td>";
		echo "</tr>";
