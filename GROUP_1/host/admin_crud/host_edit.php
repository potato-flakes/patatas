...
if(!empty($_POST["modify"])){
	$pdoQuery=$pdoConnect->prepare("update admintb set uname ='" . $_POST['uname'] . "' , pword = '"  . $_POST['pword'] . "',  fullname = '" . $_POST['fullname'] . "' where id = " . $_GET["id"]);
	...
	$pdoQuery = $pdoConnect->prepare("SELECT * FROM admintb where id=" . $_GET["id"]);
	$pdoQuery->execute();
...
<head>
	<meta charset="utf-8">
	<title>PHP PROJECT - Host-Modify_Data</title>
